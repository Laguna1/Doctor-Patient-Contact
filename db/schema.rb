...
ActiveRecord::Schema.define(version: 20_211_202_224_807) do
  ...
  create_table 'contact_with_docs', force: :cascade do |t|
    ...
    t.index %w[patient_id doctor_id], name: 'index_contact_with_docs_on_patient_id_and_doctor_id', unique: true
